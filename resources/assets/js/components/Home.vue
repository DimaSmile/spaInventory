  ...
  <div>
    <v-toolbar flat color="white">
      ...
      <v-dialog v-model="dialog" max-width="500px">
            <template v-if="$auth.check()" v-slot:activator="{ on }">
                <v-btn v-on="on"
                       color="grey darken-3"
                       dark
                       class="mb-2">
    ...
    <v-data-table :headers="headers"
        ...
        <template v-slot:items="props">
            ...
            <td v-if="$auth.check()" class="justify-center layout px-0">
    ...
    computed: {
        ...
        headers(){
            ...
            [
                ...
                { text: 'Цена розница', align: 'center', sortable: false, value: 'retailPrice' },
